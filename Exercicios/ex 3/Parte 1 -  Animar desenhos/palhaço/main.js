function main(){
  ...
  function drawClown(){
      ...
      if(ty > 1.0 || ty < -1.0)
        ty_step = -ty_step;
      ty += ty_step;
      if(scaleX > 1.0 || scaleX < 0.1)
        tx_step = -tx_step;
      scaleX += tx_step
      if(scaleY > 1.0 || scaleY < 0.1)
        ty_step = -ty_step;
      scaleY += ty_step;
      ...
      matrix = m4.scale(matrix,scaleX,scaleX,1.0);
      gl.uniformMatrix4fv(matrixUniformLocation, false, matrix);
      ...
      gl.uniform3fv(colorUniformLocation, [1.0, 0.5, 0.0]);
      ...
      gl.uniform3fv(colorUniformLocation, [1.0, 0.65, 0.55]);
      ...
      gl.uniform3fv(colorUniformLocation, [0.95, 0.2, 1.0]);
      gl.drawArrays(gl.TRIANGLES, 0, 3*n);
      ...
      gl.uniform3fv(colorUniformLocation, [1.0, 1.0, 1.0]);
      gl.drawArrays(gl.TRIANGLES, 0, 6);
      ...
      gl.uniform3fv(colorUniformLocation, [0.9, 0.8, 0.9]);
      gl.drawArrays(gl.TRIANGLES, 0, 6);
      ...
      gl.uniform3fv(colorUniformLocation, [0.5, 0.3, 1.0]);
      gl.drawArrays(gl.TRIANGLES, 0, 6);
      ...
      gl.uniform3fv(colorUniformLocation, [0.6, 0.4, 1.0]);
      gl.drawArrays(gl.TRIANGLES, 0, 6);
      ...
      requestAnimationFrame(drawClown);
  }
